...
- [ ] **RX-01**: IQ sample buffer uses thread-safe queue (queue.Queue) replacing shared numpy array
...
- [ ] **RX-07**: RX callback stripped to bare enqueue operation to minimize GIL contention
