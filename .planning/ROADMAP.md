...
- [x] 01-03-PLAN.md — Create cfar_node.py: CA-CFAR detection, persistence tracking, band classification, RFDetectionArray/RFEnvironment publish
...
- [x] 02-04-PLAN.md — RF occupancy grid: EMA power accumulation per cell, nav_msgs/OccupancyGrid publish, autonomy launch
**UI hint**: no
